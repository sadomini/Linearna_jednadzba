...
//using Linearna_jednadzba;

namespace DrawingPravac {
    ...
    public class FunctionPanel : System.Windows.Forms.Panel {
        ...
        private Function m_function1;
        private Function m_function2;
       

        private RectangleF m_displayBounds = new RectangleF(-15, -15, 30, 30);

        public Function Function1 {
            set { m_function1 = value; }
        }
        ...
        private void DrawFunction(Graphics graphics)
        {
            if (m_function1 != null)
            {
                ...
                {
                    DrawFunction2(graphics, pen, m_function1);
            ...
            if (m_function2 != null)
            {
                ...
                {
                   DrawFunction2(graphics, pen, m_function2);
                }
            }
        ...
        private void DrawFunction2(Graphics graphics, Pen pen, Function m_f)
                {
        ...
        private void MarkXAxes(Graphics graphics, Pen pen, Pen penGrid) {
            ...
            double increment = m_displayBounds.Width /15;
        ...
        private void MarkYAxes(Graphics graphics, Pen pen, Pen penGrid) {
            ...
            double increment = m_displayBounds.Height / 15;
